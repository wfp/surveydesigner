...
If you are not a member of the SurveyDesigner GitHub Project and wish to submit a
...
* [Privacy of the `survey-designer-moderation` Repository][]
* [Moderation Team][]
...
This policy applies to repositories under the SurveyDesigner
[GitHub Projects][] and all Working Groups. This policy also
applies to the [WFP Slack Community][]
...
* *Remove* refers to the act of removing the configured write (commit)
  ...
  WFP GitHub Organizations repositories as well as removing the account from
  the SurveyDesigner GitHub Project membership.
* *Block* refers to the act of prohibiting an individual GitHub account from any
  further participation in the SurveyDesigner GitHub Project. A block may be
...
Any Post in violation of the SurveyDesigner [Code of Conduct][] is
...
* Via the [global.surveydesigner@wfp.org][] email address,
...
* Via a new Post in the private `survey-designer-moderation` repository.
...
Use of the [global.surveydesigner@wfp.org][] email address -- or private email to individual
...
All emails sent to the [global.surveydesigner@wfp.org][] address are currently forwarded
...
in any public forum or any social media service outside of the GitHub
Project, Organization, or Repositories.

Note that quoting the original content of a Post within a Moderation request or
`survey-designer-moderation` repository issue is not a violation of the
...
* All Posts are expected to respect the [Code of Conduct][].
* Any Collaborator with triage permission to a given repository (except
  moderation) may Moderate Posts within that repository's issue tracker.
  Only the Moderation team is allowed to moderate posts on `moderation`.
* The Moderation Team serves as the final arbiter for all Moderation issues.
* Moderation Team members may Remove or Block an individual from the WFP
  GitHub Organization and SurveyDesigner Project.
...
* Any individual Blocked from the GitHub Project will be recommended
  for exclusion from any SurveyDesigner sponsored event or activity.
...
* When Moderating any Post authored by another Collaborator, the moderating
  ...
  * If the Moderation action included Blocking, an indication of whether the Block
    ...
    `survey-designer-moderation` repository justifying the action.
* Explanations of Moderation actions on Collaborator Posts must be provided in:
  * A new post within the original thread, or
  * A new issue within the private `survey-designer-moderation` repository.
...
* Moderation of Posts authored by non-Collaborators may result in those
  ...
  participation in the SurveyDesigner project.
...
Temporary Interaction Limits][] on any GitHub repository in the SurveyDesigner GitHub
Project.
...
The `survey-designer-moderation` Repository is used to discuss the potentially sensitive
...
`survey-designer-moderation` repository are expected to remain confidential and are not to
be discussed in any public forum or social media service.

Any Collaborator found to be violating the privacy of the `survey-designer-moderation`
repository by repeatedly sharing or discussing the details of `survey-designer-moderation`
issues in any public forum or social media service risks being permanently
removed from the SurveyDesigner GitHub Project.

## Moderation Team

The SurveyDesigner Moderation Team is tasked with enforcement of this policy.
...
- an invite to SurveyDesigner Moderation Team channel in the WFP Slack
...
be escalated to the WFP Code of Conduct Team
